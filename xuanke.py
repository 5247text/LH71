...
data={
    'username':'cuijiajia17@mails.ucas.ac.cn', #登录邮箱
    'password':'142727199509280327',  #登录密码
    'remember':'checked'
}
headers={
    'Accept':'*/*',
...
if add_flag:
    ...
    '''
    data_list=[
        {'deptIds':'952','sids':'141317','did_141317':'141317'},#生物电子学 学位课
        {'deptIds': '964', 'sids': '141469'},  # 自然辩证法概论 马克思
        {'deptIds': '952', 'sids': '141328'},  # 医疗电子技术
        {'deptIds': '951', 'sids': '141245'},  # 自然语言处理
        {'deptIds': '969', 'sids': '142451'},  # 深度学习
    ]
